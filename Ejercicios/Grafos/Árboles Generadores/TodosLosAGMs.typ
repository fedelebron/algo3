...
+ Demostrar que para todo árbol generador mínimo $T$ de $G$, si las prioridades de selección están definidas por la función:
  ...
  entonces se obtiene $T$ como resultado del algoritmo de Kruskal (resp. Prim) con órden de selección ejecutado sobre $G$ (resp. cualquiera sea el vértice inicial en el caso de Prim).
...
#solution[
  + Probemos primero que el algoritmo de Kruskal encuentra todos los árboles generadores mínimos, y luego lo mismo para el algoritmo de Prim. Llamemos $w(e) = (p(e), q_T (e))$, donde ordenamos las tuplas por órden lexicográfico. Es decir, $w(e) lt.eq w(e') arrow.double.l.r p(e) < p(e') or (p(e) = p(e') and q_T (e) < q_T (e'))$.
